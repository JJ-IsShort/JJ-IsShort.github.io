...
(def site-definition
  [{:Main_Page (fn [state] [:div "This site was designed mainly as a resume and projects site for myself. I will probably put more in depth stuff about my projects here and will fill out the main page in the future. In the mean time, feel free to check out the other pages by clicking the top right button."])}
